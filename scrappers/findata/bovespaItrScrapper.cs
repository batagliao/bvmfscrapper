...
{
    public class BovespaItrScrapper : BovespaScrapperBase, IItrScrapper
    {
        ...
        protected override async Task<IEnumerable<Cookie>> GetCookiesForBovespaAsync(DocLinkInfo info)
        {
            ...
            var url = $"http://www2.bmfbovespa.com.br/dxw/FrDXW.asp?site=B&mercado=18&razao={razao}&pregao={pregao}&ccvm={Company.CodigoCVM}&data={data}&tipo=4";
